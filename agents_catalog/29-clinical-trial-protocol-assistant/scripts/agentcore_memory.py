...
# AWS Command Line Interface (AWS CLI)ents
...
def cli(ctx):
    ...
    Create and delete AgentCore memory resources for the Clinical Trial Protocol Assistant.
    """
...
@cli.command()
@click.option(
    "--name", default="ClinicalTrialAssistantMemory", help="Name of the memory resource"
)
@click.option(
    "--ssm-param",
    default="/app/clinical-trial-assistant/agentcore/memory_id",
...
def create(name, ssm_param, event_expiry_days):
    ...
    strategies = [
        {
            StrategyType.SEMANTIC.value: {
                ...
                "namespaces": ["clinical-trial-assistant/user/{actorId}/facts"],
            },
        },
        {
            StrategyType.SUMMARY.value: {
                ...
                "namespaces": ["clinical-trial-assistant/user/{actorId}/{sessionId}"],
            },
        },
        {
            StrategyType.USER_PREFERENCE.value: {
                ...
                "namespaces": ["clinical-trial-assistant/user/{actorId}/preferences"],
            },
        },
    ]
    ...
    try:
        ...
        memory = memory_client.create_memory_and_wait(
            ...
            description="Memory for Clinical Trial Protocol Assistant",
