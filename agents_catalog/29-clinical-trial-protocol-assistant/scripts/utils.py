...
def get_cognito_client_secret() -> str:
    ...
    response = client.describe_user_pool_client(
        UserPoolId=get_ssm_parameter("/app/clinical-trial-assistant/agentcore/userpool_id"),
        ClientId=get_ssm_parameter("/app/clinical-trial-assistant/agentcore/machine_client_id"),
    )
