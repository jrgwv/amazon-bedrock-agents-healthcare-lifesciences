...
class ChatManager:
    ...
    def process_user_message(self, prompt: str, user_claims: dict, bearer_token: str):
        ...
        with st.chat_message("assistant"):
            ...
            create_safe_markdown_text(
                '<span class="thinking-bubble">🤖 💭 Clinical Trial Protocol Assistant is thinking...</span>',
                message_placeholder,
            )
    ...
    def initialize_default_conversation(self, user_claims: dict, bearer_token: str):
        ...
        if not st.session_state.messages:
            default_prompt = "Hi! I'm ready to help you design a clinical trial protocol. Please provide a disease area and trial phase (e.g., 'Phase 3 trials for non-small cell lung cancer')."
